            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                                ...
                                <div class="row">
                                    <div class="column">
                                        ...
                                        <ul class="app">
                                            <li>
                                                <a
                                                    href="{{url('https://apps.apple.com/se/app/homchf/id1591763186?l=en')}}">
                                                    <img src="{{asset('images/apple_store.png')}}" width="80%"
                                                        height="80%"> </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="app">
                                            <li>
                                                <a href="{{url('https://play.google.com/store/apps/details?id=app.homchf.homechef')}}"
                                                    target="_blank"> <img src="{{asset('images/google_play.png')}}"
                                        ...
                                        <ul class="app">
                                            <li>
                                                <a href="{{url('https://testflight.apple.com/join/025cRG2p')}}"> <img
                                                        src="{{asset('images/apple_store.png')}}" width="80%"
                                                        height="80%"> </a>
                                            </li>
                                        </ul>
                    ...
                    <form method="POST" action="{{ url('confirm_login') }}">
                        ...
                        <div class="form-group text-center">
                            <a
                                href="{{ url('https://homchf.one/public/vendor_privacy.html') }}">{{__('Privacy Policy')}}</a>
                        </div>
                        <div class="form-group text-center">
                            <a
                                href="{{ url('https://homchf.one/public/vendor_terms.html') }}">{{__('Terms Of Use')}}</a>
                        </div>
                        <div class="form-group text-center">
                            <a
                                href="{{ url('https://homchf.one/public/vendor_refund.html') }}">{{__('Refund Policy')}}</a>
                        </div>
