<div class="main-sidebar" style="overflow: auto;">
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_reports')
                <li
                    class="dropdown {{ $activePage == 'user_report' ? 'active' : '' }} || {{ $activePage == 'order_report' ? 'active' : '' }} || {{ $activePage == 'vendor_report' ? 'active' : '' }} || {{ $activePage == 'driver_report' ? 'active' : '' }} || {{ $activePage == 'earning_report' ? 'active' : '' }} || {{ $activePage == 'wallet_transaction_report' ? 'active' : '' }} || {{ $activePage == 'deposit_report' ? 'active' : '' }}">
                    <a href="javascript:void(0);" class="nav-link has-dropdown">
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        ...
                        <li class="{{ $activePage == 'vendor_report' ? 'active' : '' }}"><a
                                href="{{ url('admin/vendor_report') }}">{{ __('Vendor reports') }}</a></li>
            ...
            @can('vendor_reports')
                <li
                    class="dropdown {{ $activePage == 'user_report' ? 'active' : '' }} || {{ $activePage == 'order_report' ? 'active' : '' }} || {{ $activePage == 'vendor_report' ? 'active' : '' }} || {{ $activePage == 'driver_report' ? 'active' : '' }} || {{ $activePage == 'earning_report' ? 'active' : '' }}">
                    <a href="javascript:void(0);" class="nav-link has-dropdown">
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        <li class="{{ $activePage == 'user_report' ? 'active' : '' }}"><a
                                href="{{ url('vendor/user_report') }}">{{ __('User reports') }}</a></li>
                        <li class="{{ $activePage == 'order_report' ? 'active' : '' }}"><a
                                href="{{ url('vendor/order_report') }}">{{ __('Order reports') }}</a></li>
                    </ul>
                </li>
            @endcan
                ...
                <li
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        <li class="{{ $activePage == 'delivery_timeslot' ? 'active' : '' }}"><a
                                href="{{ url('vendor/vendor/delivery_timeslot') }}">{{ __('delivery timeslots') }}</a>
                        </li>
                        <li class="{{ $activePage == 'pickup_timeslot' ? 'active' : '' }}"><a
                                href="{{ url('vendor/vendor/pickup_timeslot') }}">{{ __('Pick up timeslots') }}</a>
                        </li>
                        <li class="{{ $activePage == 'selling_timeslot' ? 'active' : '' }}"><a
                                href="{{ url('vendor/vendor/selling_timeslot') }}">{{ __('selling timeslots') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
