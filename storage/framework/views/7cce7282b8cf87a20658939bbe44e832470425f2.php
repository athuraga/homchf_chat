                ...
                <div class="col-lg-8 col-12 col-md-6 order-lg-1 order-1 min-vh-100 background-walk-y overlay-gradient-bottom" data-background="<?php echo e(url('images/1.png')); ?>" style="background-color: #23110f">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold"><?php echo e(__("welcome HomChf...!!")); ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/admin/admin setting/admin_forgot_password.blade.php ENDPATH**/ ?>