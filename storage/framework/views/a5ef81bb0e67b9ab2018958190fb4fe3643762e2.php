                    ...
                    <div class="p-4 m-3">
                        ...
                        <form method="POST" action="<?php echo e(url('admin/admin_forgot_password')); ?>">
                            ...
                            <div class="form-group text-center">
                                <a href="<?php echo e(url('vendor/login')); ?>"><?php echo e(__('Login')); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/vendor/vendor_profile/vendor_forgot_password.blade.php ENDPATH**/ ?>