...
<section class="section">
    <div class="section-header">
        <h1><?php echo e($submenu->name); ?>&nbsp;<?php echo e(__('Customize')); ?></h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo e(url('vendor/vendor_home')); ?>"><?php echo e(__('Dashboard')); ?></a></div>
            <div class="breadcrumb-item active"><a href="<?php echo e(url('vendor/vendor_menu')); ?>"><?php echo e(App\Models\Menu::find($submenu->menu_id)->name); ?></a></div>
            <div class="breadcrumb-item active"><a href="<?php echo e(url('vendor/vendor_menu/'.$submenu->menu_id)); ?>"><?php echo e(App\Models\Submenu::find($submenu->id)->name); ?></a></div>
    ...
    <div class="section-body">
        ...
        <p class="section-lead"><?php echo e(__('Custimization submenu')); ?></p>
        <div class="card">
            <div class="card-header">
                <h4><?php echo e(__('Customize')); ?></h4>
                <div class="w-100">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_custimization_type_add')): ?>
                        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#staticBackdrop"><?php echo e(__('Add customization type')); ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_custimization_type_access')): ?>
                <div class="card-body">
                    <div id="accordion">
                        <?php $__currentLoopData = $custimization_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custimization_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="accordion">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_custimization_type_edit')): ?>
                                        <span>
                                        ...
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_custimization_type_delete')): ?>
                                        <span>
                                                        ...
                                                        <tbody id="<?php echo e('custom'.$custimization_type->id); ?>">
                                                            ...
                                                            <?php if($items): ?>
                                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" name="<?php echo e(str_replace(' ', '_', strtolower('name'.$custimization_type->name.'[]'))); ?>" placeholder="<?php echo e(__('Item name')); ?>" value="<?php echo e($item->name); ?>" class="form-control" style="text-transform: none;">
                                                                        </td>
                                                                        <td>
                                                                            <input type="number" name="price[]" value="<?php echo e($item->price); ?>" placeholder="<?php echo e(__('Price')); ?>" class="form-control">
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <?php if($loop->iteration == 1): ?>
                                                                            <td>
                                                                                <button type="button" class="btn btn-primary update_custimization" onclick="update_custimization(<?php echo e($custimization_type->id); ?>,'<?php echo e(strtolower($custimization_type->name)); ?>')">+</button>
                                                                            </td>
                                                                        <?php else: ?>
                                                                            <td>
                                                            ...
                                                            <?php else: ?>
                                                                <tr id="<?php echo e('custom'.$custimization_type->id); ?>">
                                                                    <td>
                                                                        <input type="text" required name="<?php echo e(str_replace(' ', '_', strtolower('name'.$custimization_type->name.'[]'))); ?>" placeholder="<?php echo e(__('Item name')); ?>" class="form-control" style="text-transform: none;">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" required name="price[]" placeholder="<?php echo e(__('Price')); ?>" class="form-control">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-primary" onclick="update_custimization(<?php echo e($custimization_type->id); ?>,'<?php echo e(strtolower($custimization_type->name)); ?>')">+</button>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        </tbody>
        ...
        <div class="modal-content">
            <form action="<?php echo e(url('admin/customization_type')); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <label for=""><?php echo e(__('Name of Custimization type')); ?><span class="text-danger">&nbsp;*</span></label>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <label for=""><?php echo e(__('Minimum Item selection')); ?><span class="text-danger">&nbsp;*</span></label>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <label for=""><?php echo e(__('Maximum Item selection')); ?><span class="text-danger">&nbsp;*</span></label>
                    ...
                    <div class="form-group mt-5">
                        <div class="control-label"><?php echo e(__('Type')); ?><span class="text-danger">&nbsp;*</span></div>
...
<?php echo $__env->make('layouts.app',['activePage' => 'vendor_menu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/vendor/custimization submenu/custimization_submenu.blade.php ENDPATH**/ ?>