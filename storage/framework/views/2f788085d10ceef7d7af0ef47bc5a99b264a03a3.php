                        ...
                        * {
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                <ul class="app">
                                    <li>
                                        <a href="<?php echo e(url('https://apps.apple.com/se/app/homchf/id1591763186?l=en')); ?>">
                                            <img src="<?php echo e(asset('images/apple_store.png')); ?>" width="80%" height="80%">
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <ul class="app">
                                    <li>
                                        <a href="<?php echo e(url('https://play.google.com/store/apps/details?id=app.homchf.homechef')); ?>"
                                            target="_blank"> <img src="<?php echo e(asset('images/google_play.png')); ?>" width="80%"
                                                height="80%"> </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="app">
                                    <li>
                                        <a href="<?php echo e(url('https://testflight.apple.com/join/025cRG2p')); ?>"> <img
                                                src="<?php echo e(asset('images/apple_store.png')); ?>" width="80%" height="80%"> </a>
                                    </li>
                                </ul>
...
</html><?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/vendor/vendor_login.blade.php ENDPATH**/ ?>