        ...
        <ul class="sidebar-menu">
                ...
                <li
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        ...
                        <li class="<?php echo e($activePage == 'vendor_report' ? 'active' : ''); ?>"><a
                                href="<?php echo e(url('admin/vendor_report')); ?>"><?php echo e(__('Vendor reports')); ?></a></li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_reports')): ?>
                <li
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        <li class="<?php echo e($activePage == 'user_report' ? 'active' : ''); ?>"><a
                                href="<?php echo e(url('vendor/user_report')); ?>"><?php echo e(__('User reports')); ?></a></li>
                        <li class="<?php echo e($activePage == 'order_report' ? 'active' : ''); ?>"><a
                                href="<?php echo e(url('vendor/order_report')); ?>"><?php echo e(__('Order reports')); ?></a></li>
                    </ul>
                </li>
            <?php endif; ?>
...
<?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>