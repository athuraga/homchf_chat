                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_app_id" value="<?php echo e($notification_setting->customer_app_id); ?>" required class="form-control" style="text-transform: none">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_auth_key" value="<?php echo e($notification_setting->customer_auth_key); ?>" required class="form-control" style="text-transform: none">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-12">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_api_key" value="<?php echo e($notification_setting->customer_api_key); ?>"  required class="form-control" style="text-transform: none">
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app',['activePage' => 'setting'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/admin/setting/notification_setting.blade.php ENDPATH**/ ?>