...
<section class="section">
    <div class="section-header">
        <h1><?php echo e($submenu->name); ?>&nbsp;<?php echo e(__('Customise')); ?></h1>
                                                                ...
                                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        ...
                                                                        <?php if($loop->iteration == 1): ?>
                                                                            <td>
                                                                                <button type="button" class="btn btn-primary update_custimization" onclick="update_custimization(<?php echo e($custimization_type->id); ?>,'<?php echo e($custimization_type->name); ?>')">+</button>
                                                                            </td>
                                                                        <?php else: ?>
                                                                            <td>
...
<?php echo $__env->make('layouts.app',['activePage' => 'vendor'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/admin/custimization submenu/custimization_submenu.blade.php ENDPATH**/ ?>