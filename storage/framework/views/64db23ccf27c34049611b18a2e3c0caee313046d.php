<?php $__env->startSection('title','Vendor Selling Timeslots'); ?>

<?php $__env->startSection('content'); ?>

<section class="section">
    <div class="section-header">
        <h1><?php echo e($vendor->name); ?>&nbsp;<?php echo e('Selling timeslot'); ?></h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo e(url('vendor/vendor_home')); ?>"><?php echo e(__('Dashboard')); ?></a></div>
            <div class="breadcrumb-item"><?php echo e(__('Selling Time Slots')); ?></div>
        </div>
    </div>
    <div class="section-body">
        <h2 class="section-title"><?php echo e(__("Selling Time Slots")); ?></h2>
        <p class="section-lead"><?php echo e(__('Add and Edit Selling Time Slots')); ?></p>
        <div class="card p-5">
            <div class="row">
                ...
                <div class="table-responsive">
                    <form action="<?php echo e(url('admin/update_selling_timeslot')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app',['activePage' => 'selling_timeslot'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /customers/f/2/a/homchf.one/httpd.www/resources/views/vendor/vendor/edit_selling_timeslot.blade.php ENDPATH**/ ?>